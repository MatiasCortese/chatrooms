...
customElements.define("welcome-page", class extends HTMLElement {
    ...
    getInputsData(){
        const email = (document.querySelector("#email").querySelector(".input") as any).value;
        const nombre = (document.querySelector("#nombre").querySelector(".input") as any).value;
        const roomId = (document.querySelector(".room-id-form").querySelector(".input") as any).value;
        if(!email || !nombre) {
    ...
    getRoomType(){
        const roomType = (document.querySelector(".select") as any).value;
